...
def load_dataset(dataset_name):
    ...
    # a = [ (data.y==c).sum(0).item() for c in range(data.num_classes)]
    # print(a)
    # print(sorted(a))
...
def make_pu_dataset(data, pos_index=[0], fixed_seed=True,
    ...
    # sample
    data.un_train_mask[perm_remaining_idx[:round(3* pos_num * train_pct)]] = True # The number is the same as that of pos_train_mask
